...
const menuImage = '/assets/images/hamburger.png'
const menuCloseImage = '/assets/images/close.png'
          ...
          <div className="menu-list-section">
            ...
            <div >
              ...
              {Object.entries(metaInfo).map(([menuIdx, videoList]) => {
                ...
                return (
                <div key={menuIdx}>
                  <div className="menu-button-category" onClick={() => {
                        toggleMenu();
                  ...
                  <ul className="menu-button-video-ul">
                    {videoList.videos.map(video => (
                      <ul key={video.video_menu_title}>
                        {video.video_menu_title}
                      </ul>
                    ))}
                  </ul>
                </div>
